...
def STAFF_TAKE_ATTENDANCE(request):
    ...
    for i in subjects:
        ...
        students = Student.objects.filter(branch_id=student_id)
...
def STAFF_SAVE_ATTENDANCE(request):
    if request.method == "POST":
        ...
        for i in student_id:
            ...
            messages.success(request, 'Attendance Save successfully !!!')
...
def STAFF_SAVE_RESULT(request):
    if request.method == 'POST':
        ...
        if check_exits:
            ...
            result.save()
            messages.success(request, 'Result Add Successfully Updated !!!')
